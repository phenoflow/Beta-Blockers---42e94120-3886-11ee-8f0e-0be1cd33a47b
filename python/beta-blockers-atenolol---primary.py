...
codes = [{"code":"19191","system":"gprdproduct"},{"code":"24","system":"gprdproduct"},{"code":"31934","system":"gprdproduct"},{"code":"33079","system":"gprdproduct"},{"code":"46908","system":"gprdproduct"}];
REQUIRED_CODES = 1;
